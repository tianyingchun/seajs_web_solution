        ...
        _this.init = function(force, forceCalcSlides) {
            ...
            if (params.slidesPerView === "auto") {
                ...
                if (params.calculateHeight) {
                    ...
                    if (isH) wrapperHeight = slideHeight; else containerSize = slideHeight, _this.container.style.height = containerSize + "px";
                } else {
    ...
    ====================================================*/
        ...
        _this.calcVisibleSlides = function(position) {
            ...
            for (var i = 0; i < _this.slides.length; i++) {
                ...
                if (params.slidesPerView == "auto") _slideSize = isH ? _this.h.getWidth(_this.slides[i], true) : _this.h.getHeight(_this.slides[i], true); else _slideSize = slideSize;
